...
//	wire		[35:0]	f_word;	//F_WORD=2^累加寄存器位��?*输出频率/时钟频率
	reg		[11:0]	p_word;	//P_WORD=相位/360*(2^rom地址位数)

	always@( posedge clk or negedge rst_n )
		begin
			if(!rst_n) p_word <= 12'b0;
			else p_word <= {1'b0,phase,3'b0} + {3'b0,phase,1'b0} + {4'b0,phase} + {5'b0,phase[7:1]};
		end
//////////////////////////////
	reg		[3:0]   En_r;
...
/////////////////////////////////////////	
	...
	dds_ctrl_lite_phase	dds_ctrl_lite_phase_inst
	(
		.clk		(clk),
		.rst_n		(DDS_en),
...
//////////////////////////////
	...
	// 		else 
	// 			case(parameter_70)
	// 			8'd1:	dac_data <= dac_data_reg;
	// 			8'd2:	dac_data <= dac_data_reg;
	// 			8'd3:	dac_data <= dac_data_reg;
	// 			8'd4:	dac_data <= dac_data_reg;
	// 			8'd5:	dac_data <= dac_data_reg;
	// 			8'd6:	dac_data <= dac_data_reg;
	// 			8'd7:	dac_data <= dac_data_reg;
	// 			8'd8:	dac_data <= dac_data_reg;
	// 			8'd9:	dac_data <= dac_data_reg;
	// 			8'd10:	dac_data <= dac_data_reg;
	// 			8'd11:	dac_data <= dac_data_reg;
	// 			8'd12:	dac_data <= dac_data_reg;
	// 			8'd12:	dac_data <= dac_data_reg;
	// 			8'd14:	dac_data <= dac_data_reg;
	// 			8'd15:	dac_data <= dac_data_reg;
	// 			8'd16:	dac_data <= dac_data_reg;
	// 			8'd17:	dac_data <= dac_data_reg;
	// 			8'd18:	dac_data <= dac_data_reg;
	// 			8'd19:	dac_data <= dac_data_reg;
	// 			8'd20:	dac_data <= dac_data_reg;
	// 			8'd21:	dac_data <= dac_data_reg;
	// 			8'd22:	dac_data <= dac_data_reg;
	// 			8'd23:	dac_data <= dac_data_reg;
	// 			8'd24:	dac_data <= dac_data_reg;
	// 			8'd25:	dac_data <= dac_data_reg;
	// 			8'd26:	dac_data <= dac_data_reg;
	// 			8'd27:	dac_data <= dac_data_reg;
	// 			8'd28:	dac_data <= dac_data_reg;
	// 			8'd29:	dac_data <= dac_data_reg;
	// 			8'd30:	dac_data <= dac_data_reg;
	// 			8'd31:	dac_data <= dac_data_reg;
	// 			8'd32:	dac_data <= dac_data_reg;
	// 			8'd33:	dac_data <= dac_data_reg;
	// 			8'd34:	dac_data <= dac_data_reg;
	// 			8'd35:	dac_data <= dac_data_reg;
	// 			8'd36:	dac_data <= dac_data_reg;
	// 			default:dac_data <= dac_data;
	// 			endcase
	// 	end
