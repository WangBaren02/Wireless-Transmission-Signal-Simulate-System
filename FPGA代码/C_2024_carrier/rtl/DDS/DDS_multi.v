...
////////////////////////////////////////////////////
	reg		[35:0]	f_word;	//F_WORD=2^ç´¯åŠ å¯„å­˜å™¨ä½ï¿??*è¾“å‡ºé¢‘çŽ‡/æ—¶é’Ÿé¢‘çŽ‡

	always@( posedge clk or negedge rst_n )
		begin
			if(!rst_n) f_word <= 36'd0;
			else 
				case(frequency_multi)
...
/////////////////////////////////////////////////////
	reg		[11:0]	p_word;	//P_WORD=ç›¸ä½/360*(2^romåœ°å€ä½æ•°)
...
/////////////////////////////////////////	
	dds_ctrl_multi dds_ctrl_multi_inst
	(
		.clk		(clk),
		.rst_n		(DDS_en),
		.f_word		(f_word),
